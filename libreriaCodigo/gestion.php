    ...
    <div class="card-header">
      ...
      <div class="card-header-row" style="flex:1">
        <div class="cal-nav">
          ...
          <button class="btn btn-ghost btn-sm" onclick="cambiarMes(1)">▶</button>
          <select id="calSelMes" onchange="irAFecha()" style="border:1px solid var(--border);border-radius:6px;padding:3px 6px;font-size:13px;color:var(--text);background:var(--surface)">
            <option value="0">Enero</option><option value="1">Febrero</option><option value="2">Marzo</option>
            <option value="3">Abril</option><option value="4">Mayo</option><option value="5">Junio</option>
            <option value="6">Julio</option><option value="7">Agosto</option><option value="8">Septiembre</option>
            <option value="9">Octubre</option><option value="10">Noviembre</option><option value="11">Diciembre</option>
          </select>
          <select id="calSelAnyo" onchange="irAFecha()" style="border:1px solid var(--border);border-radius:6px;padding:3px 6px;font-size:13px;color:var(--text);background:var(--surface)">
